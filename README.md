...
![Summary Statistics](asset/summary_statistics.png)
![Summary Statistics](asset/summary_statistics_2.png)
...
6. **Discount-Dependent Products** - Identified 5 products with the highest percentage of discounted purchases.
   ...
   ![Discount-Dependent Products](asset/discount_dependent_products.png)
...
9. **Top 3 Products per Category** - Listed the most purchased products within each category.
   ...
   ![Top 3 Products per Category](asset/top_3_products_per_category.png)
   
10. **Repeat Buyers and Subscriptions** - Checked whether customers with more than 5 purchases are more likely to subscribe.

   ![Repeat Buyers & Subscriptions](asset/repeat_buyers_and_subscriptions.png)
...
11. **Revenue by Age Group** - Calculated total revenue contribution of each age group.
    ...
    ![Revenue by Age Group](asset/revenue_by_age_group.png)
